(function(){
  ...
  const initialTheme = data.themes[requestedTheme] ? requestedTheme : 'behoerdengang';
  const state = { theme:initialTheme, view:'board', cardIndex:0, cardBack:false, dialogStep:1, builderPattern:null, builderMiddle:null, builderEnd:null, worksheetTab:'sheet', sicherungOpen:{}, timerSeconds:300, timerRemaining:300, timerRunning:false, timerEndAt:null };
